...
@MODELS.register_func('DSHyFANet_model')
def build_dshyfanet_model(C):
    from models.DSHyFANet import DSHyFANet
    return DSHyFANet()


@MODELS.register_func('GeSANet_model')
def build_cdwcnet_model(C):
    from models.GeSANet.GeSANet import GeSANet
    return GeSANet('resnet18')
