...
from models._blocks import Conv3x3, Conv1x1, get_norm_layer
from models._utils import Identity, KaimingInitMixin
...
if __name__ == '__main__':
    ...
    # feats = [x, y, z]
    net = BIT(in_ch=3, out_ch=2, backbone='resnet18',
              n_stages=4, token_len=4, enc_with_pos=True,
              enc_depth=1, dec_depth=8, dec_head_dim=8)
    # pred = net(t1, t2)
    stat(net, (3, 256, 256))
